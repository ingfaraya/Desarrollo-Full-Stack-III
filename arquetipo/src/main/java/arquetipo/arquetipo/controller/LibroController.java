package arquetipo.arquetipo.controller;

import arquetipo.arquetipo.model.Libro;
import arquetipo.arquetipo.service.LibroService;
...
@RestController
@RequestMapping("api/arquetipo")
public class LibroController {

    @Autowired
    private LibroService libroService;

    // Requiere autenticación para obtener todos los arquetipo
